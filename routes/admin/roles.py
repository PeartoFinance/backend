...
def get_permission_keys():
    ...
    return jsonify({
        ...
        'descriptions': {
            ...
            'ai_features': 'AI agent and content writer',
            'system': 'Tools, support, tasks, audit',
            'apis_integration': 'API control and registry',
            'configuration': 'Settings and appearance',
            'roles_management': 'Manage admin roles (superadmin only)',
        }
    })
